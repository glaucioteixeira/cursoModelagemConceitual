...
import br.com.cenarioesolucao.cursoModelagemConceitual.domain.Pagamento;
import br.com.cenarioesolucao.cursoModelagemConceitual.domain.PagamentoComBoleto;
import br.com.cenarioesolucao.cursoModelagemConceitual.domain.PagamentoComCartao;
...
import br.com.cenarioesolucao.cursoModelagemConceitual.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "glauciojrteixeira@gmail.com", "36378912377", 
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "glaucio.teixeira@outlook.com", "31628382740", 
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("99500593", "99117270"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Geraldo Ramos", "170", "Casa", "Novo Santa Cecilia", "30626692", cli2, c2);
